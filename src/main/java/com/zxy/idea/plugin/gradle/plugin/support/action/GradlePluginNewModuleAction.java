 ...
 */
public class GradlePluginNewModuleAction extends AnAction implements DumbAware {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        Pair<File, File> pair = ModuleTemplateHelper.getGradlePluginTemplate();
        if (pair == null)
            return;
        ...
        ModelWizard wizard = new ModelWizard.Builder()
                .addStep(new ConfigureGradlePluginModuleStep(new GradlePluginModuleModel(project, new TemplateHandle(template), pair.getSecond()), "Gradle Plugin", ModuleType.GRADLE_PLUGIN))
                .build();
